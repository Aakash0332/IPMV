...
grass_locations = [(400, 450), (400, 320), (440, 300), (450, 450)]
grass_patches = []
for loc in grass_locations:
 ...
 print(loc[0], loc[1])
 #
cv2.imshow("1",image[loc[0]:loc[0]+PATCH_SIZE,loc[1]:loc[1]+PATCH_SIZE])
# select some patches from sky areas of the image
sky_locations = [(38, 34), (139, 28), (37, 437), (145, 379)]
sky_patches = []
for loc in sky_locations:
 sky_patches.append(image[loc[0]:loc[0] + PATCH_SIZE,loc[1]:loc[1]
+ PATCH_SIZE])
 print(loc[0], loc[1])
 # cv2.imshow("2",image[loc[0]:loc[0] + PATCH_SIZE,loc[1]:loc[1] +PATCH_SIZE])
...
'go',label='Grass')
ax.plot(xs[len(sky_patches):], ys[len(sky_patches):],
'bo',label='Sky')
